...
def main():
    ...
    print()
    while not login():
        print("\nNiste uneli postojeće ime i lozinku!")
        # return
    komanda = '0'
    while komanda != 'X':
        komanda = menu()
...
def printMenu():
    print("\nIzaberite opciju:")
    print("  1 - pronalaženje studenta")
    print("  2 - pretraživanje studenata")
...
def findStudent():
    ...
    if stud != None:
        ...
        print("Nije pronađen student sa brojem indeksa", indeks)
