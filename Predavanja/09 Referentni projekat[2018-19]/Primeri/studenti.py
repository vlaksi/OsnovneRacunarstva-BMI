...
def formatHeader():
    return \
      "Indeks  |Ime       |Prezime     |Ime rod.  |Datum rođ. |JMBG         |Email               |Godina\n" \
      "--------+----------+------------+----------+-----------+-------------+--------------------+------"
...
def main():
  # student = findStudent("E2")
  # print("student E2: ", student)
  # student = findStudent("x2")
  # print("student x2: ", student)
  # student = searchStudents("ime","Nedelj")
  # print(student)
  # header = formatHeader()
  # print(header)
  # formatirano = formatStudent(student)
  # print(formatirano)
  studenti.sort(key=lambda x : x["indeks"])
  print(formatStudents(studenti))
  # sortStudents("indeks")
  # print("sortirano")
  # print(formatStudents(studenti))
